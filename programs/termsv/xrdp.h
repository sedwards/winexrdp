...
#define XRDP_CFG_PATH "/data/xrdp"
#define XRDP_PID_PATH "/data/xrdp"
#define XRDP_SHARE_PATH "/data/xrdp"
#define XRDP_MODULE_PATH "/data/xrdp"
#define XRDP_SOCKET_PATH "/data/xrdp"
